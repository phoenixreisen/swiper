(function () {
    ...
    Swiper.use([Navigation$1, Pagination$1, Scrollbar$1]);
    var Slider = {
        oncreate: function (vnode) {
            var state = vnode.state, attrs = vnode.attrs, dom = vnode.dom;
        ...
        view: function (_a) {
            ...
            return (mithril("div", { class: "swiper-container" },
                mithril("div", { class: "swiper-wrapper" }, slides.map(function (slide, index) {
                    return mithril("div", { key: "slide-" + index, class: "swiper-slide" }, slide);
                })),
